...
public class MockHttpServletRequest implements HttpServletRequest
{
   ...
   public MockHttpServletRequest(HttpSession session, final String principalName, Set<String> principalRoles, Cookie[] cookies, String method)
   {
      this(null, method, "");
   ...
   {
      HeaderValueHolder header = HeaderValueHolder.getByName(this.headers, name);
      return (header == null || header.getValue() == null ) ? null : header.getValue().toString();
   }
